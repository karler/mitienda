<h1 class="mt-4"><?=$titulo?></h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form method="post" action="<?=base_url()?>/public/Productos/insertar">
                                    <!--Código-->
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="codigo" name="codigo" placeholder="Introdusca el Código" type="text" class="form-control">
                                        </div>
                                        </div>
                                    </div>
                                    <!--Nombre-->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="existencias" name="existencias" placeholder="¿Cuántos tienes?" type="text" class="form-control" >
                                        </div>
                                        </div>
                                    </div>
                                    <!--Stock Mínimo-->
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <div class="input-group">
                                                ...
                                                <input id="stock_minimo" name="stock_minimo" placeholder="Ingresa el Stock mínimo" type="text" class="form-control" >
                                            </div>
                                        </div>
                                    </div>

                                    <!--inventariable - 0 = false  1= true-->         
                                    <div class="form-group row">
                                        <label for="inventariable" class="col-3 col-form-label">Inventariable</label> 
                                        <div class="col-9">
                                        <select id="inventariable" name="inventariable" required="required" class="custom-select">
