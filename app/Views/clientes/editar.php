                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form method="post" action="<?=base_url()?>/public/Clientes/actualizar">
                                <div class="form-group row">
                                    <label for="idcliente" class="col-3 col-form-label">Id Cliente</label> 
                                    <div class="col-9">
                                    <div class="input-group">
                                        ...
                                        <input id="idcliente" name="idcliente" type="text" class="form-control" value="<?=$datos['idcliente']?>" readonly>
                                    </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="direccion" name="direccion" type="text" class="form-control" value="<?=$datos['direccion']?>">
                                    </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="telefono" name="telefono" type="text" class="form-control" value="<?=$datos['telefono']?>">
                                    </div>
                                    </div>
                                </div>
                                <div class="form-group row">
