<h1 class="mt-4"><?=$titulo?></h1>
                        ...
                        <div>
                            ...
                            <a href="<?=base_url()?>/public/Clientes" class='btn btn-primary'>regresar</a>
                                        ...
                                        <tbody>
                                            <?php
                                                foreach ($datos as $dat){
                                                    ...
                                                    echo "<td class='text-center'><a href='".base_url()."/public/Clientes/restaurar/".$dat['idcliente']."' class='btn btn-primary'><i class='fas fa-trash-alt'></i></a></td>";
                                                    echo "</tr>";
                                                }
                                            ?>  
                                        </tbody>
